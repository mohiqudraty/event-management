...
const Testimonial = ({ review }) => {
  const { name, img, event, testimonial } = review;
  // console.log(review);
    ...
    <>
      <div>
        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-blue-700 cursor-pointer shadow-md md:p-12 p-6 border-8">
          ...
          <div className="text-white group-hover:text-blue-700 absolute bottom-0 -mb-6">
            <svg
              width={34}
              height={28}
              viewBox="0 0 34 28"
        ...
        <div className="flex flex-col items-center justify-center mt-5">
          <img src={img} alt={`Picture of ${name}`} className="w-12 h-12" />
