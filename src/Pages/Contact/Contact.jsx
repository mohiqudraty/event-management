...
const Contact = () => {
  const handleContact = (e) => {
    e.preventDefault();
    toast.success(
      "Your Massage Submitted. Please Wait for Our Response. ThankYou"
    );
  };

  return (
    <div className="container mx-auto pt-16 mb-10">
        ...
        <div className="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">
              Do you have questions about our services, want to explore
              partnership opportunities, or simply wish to say hello? Feel free
              to contact us! We are here to assist you in creating memorable and
              exceptional events.
            </p>
            ...
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">
                info@socialeventmanagement.com
              </p>
            </div>
            <p className="text-lg text-white pt-10 tracking-wide">
              123/A, New Baily Road <br />
